...
namespace JMO_Assets.Cartoon_FX_Remaster.CFXR_Assets.Editor
{
    public static class ExpressionParser
    {
        ...
        static public Expression MakeExpression(ref List<Token>.Enumerator polishNotationTokensEnumerator,
        ...
        public class Token
        {
            ...
            static Dictionary<char, KeyValuePair<TokenType, string>> typesDict =

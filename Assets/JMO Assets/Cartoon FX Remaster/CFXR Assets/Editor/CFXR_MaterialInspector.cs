...
namespace JMO_Assets.Cartoon_FX_Remaster.CFXR_Assets.Editor
{
                    ...
                    foreach (var l in lines)
                    {
                        ...
                        if (insideProperties)
                        {
                            ...
                            if (line.StartsWith(kGuiCommandPrefix))
                            {
                                ...
                                {
                                    var expr = command.Substring(command.LastIndexOf(kGC_IfKeyword) +
                                ...
                                {
                                    var expr = command.Substring(command.LastIndexOf(kGC_IfProperty) +
                                ...
                                {
                                    var label = command.Substring(command.LastIndexOf(kGC_Label) + kGC_Label.Length +
                                                                  1);
    ...
    internal class MaterialKeywordEnumNoPrefixDrawer : MaterialPropertyDrawer
    {
        ...
        public MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3,
            string kw3, string lbl4, string kw4) : this(new[] { lbl1, lbl2, lbl3, lbl4 }, new[] { kw1, kw2, kw3, kw4 })
        {
        }

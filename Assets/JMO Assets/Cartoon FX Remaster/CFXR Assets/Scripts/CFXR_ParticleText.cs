...
#pragma warning restore 0649
        ...
        )
        {
            ...
            {
                throw new System.Exception(
                    "[CFXR_ParticleText] You cannot update the text if it's not marked as dynamic.");
            }
    ...
    {
        GUIContent GUIContent_AutoUpdateToggle = new GUIContent("Auto-update",
            "Automatically regenerate the text when a property is changed.");

        GUIContent GUIContent_UpdateTextButton = new GUIContent(" Update Text ",
